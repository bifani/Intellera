...
# import sphinx
import collections
from numpydoc import NumpyDocString, FunctionDoc  # , ClassDoc
    ...
    def _str_member_list(self, name):
        ...
        if self[name]:
            ...
            for param, param_type, desc in self[name]:
                ...
                if not (
                    callable(param_obj) or isinstance(param_obj, property) or inspect.isgetsetdescriptor(param_obj)
                ):
                    param_obj = None
...
def get_doc_object(obj, what=None, doc=None, config={}):
    ...
    #                           config=config)
    if what in ("function", "method"):  # elif
