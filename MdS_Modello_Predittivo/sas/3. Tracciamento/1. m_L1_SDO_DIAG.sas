...
proc printto log="C:\Users\r.blaco\Desktop\scripts Modello predittivo 20220706\logs\L1_SDO_DIAG.txt" new;
run;
...
%macro L1_SDO_DIAG(ID_CLASSIFICAZIONE=, reg=);
	PROC SQL;
...
*/
	********** RICOVERI *******************;
		...
		PROC SQL;
			CREATE TABLE TEMP.L1_SDO_DIAG_WRK_&reg AS
				SELECT
					ID_CLASSIFICAZIONE,
					ID_INDICATORE,
					ID_ANONIMO,
		...
		proc delete DATA= TEMP.CRIT_L1_DIAG_PROFONDITA TEMP.TMP_L1_DIAG_01_&reg TEMP.TMP_L1_DIAG_02_&reg;
		run;
...
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=010);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=020);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=030);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=041);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=042);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=050);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=060);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=070);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=080);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=090);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=100);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=110);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=120);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=130);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=140);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=150);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=160);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=170);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=180);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=190);
%L1_SDO_DIAG(ID_CLASSIFICAZIONE=9,reg=200);
